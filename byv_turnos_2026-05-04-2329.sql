...
INSERT INTO `profesionales` (`id`, `user_id`, `nombre`, `consultorio_default_id`, `duracion_default`) VALUES
	...
	(3, 5, 'Dr. Gómez, Carlos', 3, 45),
	(4, 4, 'Lic Daniela Manzoti', 3, 15);
...
-- Volcando datos para la tabla byv_turnos.turnos: ~9 rows (aproximadamente)
DELETE FROM `turnos`;
INSERT INTO `turnos` (`id`, `paciente_id`, `profesional_id`, `consultorio_id`, `fecha_hora`, `estado_id`, `sobreturno`, `fecha_creacion`, `observaciones`, `duracion_minutos`) VALUES
	...
	(10, 1, 1, 1, '2026-05-07 08:00:00', 1, 0, '2026-05-05 02:28:19', 'Control cardiología', 30),
	...
	(40, 4, 2, 2, '2026-05-05 14:00:00', 2, 0, '2026-05-05 02:28:19', 'Realizado', 30),

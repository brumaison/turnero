...
-- Volcando datos para la tabla byv_turnos.agendas: ~12 rows (aproximadamente)
INSERT INTO `agendas` (`id`, `profesional_id`, `dia_semana`, `hora_inicio`, `hora_fin`, `duracion_minutos`, `activo`, `created_at`) VALUES
	(1, 1, 1, '09:00:00', '12:00:00', 30, 1, '2026-03-24 04:00:58'),
	(2, 1, 1, '16:00:00', '20:00:00', 30, 1, '2026-03-24 04:00:58'),
	(3, 1, 3, '09:00:00', '12:00:00', 30, 1, '2026-03-24 04:00:58'),
	(4, 1, 5, '09:00:00', '12:00:00', 30, 1, '2026-03-24 04:00:58'),
	(5, 2, 2, '08:00:00', '13:00:00', 30, 1, '2026-03-24 04:00:58'),
	(6, 2, 4, '08:00:00', '13:00:00', 30, 1, '2026-03-24 04:00:58'),
	(7, 1, 1, '09:00:00', '12:00:00', 30, 1, '2026-03-25 00:19:00'),
	(8, 1, 1, '16:00:00', '20:00:00', 30, 1, '2026-03-25 00:19:00'),
	(9, 1, 3, '09:00:00', '12:00:00', 30, 1, '2026-03-25 00:19:00'),
	(10, 1, 5, '09:00:00', '12:00:00', 30, 1, '2026-03-25 00:19:00'),
	(11, 2, 2, '08:00:00', '13:00:00', 30, 1, '2026-03-25 00:19:00'),
	(12, 2, 4, '08:00:00', '13:00:00', 30, 1, '2026-03-25 00:19:00');
...
-- Volcando datos para la tabla byv_turnos.consultorios: ~5 rows (aproximadamente)
INSERT INTO `consultorios` (`id`, `sede_id`, `nombre`, `direccion`, `telefono`) VALUES
	(1, NULL, 'Consultorio Central - Planta Baja', NULL, NULL),
	(2, NULL, 'Consultorio 2 - Primer Piso', NULL, NULL),
	(3, NULL, 'Consultorio 3 - Primer Piso', NULL, NULL),
	(4, NULL, 'Box de Urgencias', NULL, NULL),
	(5, NULL, 'Sala de Kinesiología', NULL, NULL);
...
-- Volcando datos para la tabla byv_turnos.especialidades: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla byv_turnos.pacientes: ~10 rows (aproximadamente)
INSERT INTO `pacientes` (`id`, `dni`, `nombre`, `apellido`, `email`, `telefono`, `fecha_alta`) VALUES
	(1, '34567890', 'Pedro', 'González', 'pedro.gonzalez@email.com', '11-1234-5678', '2026-03-23 05:18:07'),
	(2, '34567891', 'Laura', 'Sánchez', 'laura.sanchez@email.com', '11-2345-6789', '2026-03-23 05:18:07'),
	(3, '34567892', 'Carlos', 'Ramírez', 'carlos.ramirez@email.com', '11-3456-7890', '2026-03-23 05:18:07'),
	(4, '34567893', 'María', 'López', 'maria.lopez@email.com', '11-4567-8901', '2026-03-23 05:18:07'),
	(5, '34567894', 'José', 'Díaz', 'jose.diaz@email.com', '11-5678-9012', '2026-03-23 05:18:07'),
	(6, '34567895', 'Ana', 'Martínez', 'ana.martinez@email.com', '11-6789-0123', '2026-03-23 05:18:07'),
	(7, '34567896', 'Luis', 'Rodríguez', 'luis.rodriguez@email.com', '11-7890-1234', '2026-03-23 05:18:07'),
	(8, '34567897', 'Sofía', 'Fernández', 'sofia.fernandez@email.com', '11-8901-2345', '2026-03-23 05:18:07'),
	(9, '34567898', 'Miguel', 'García', 'miguel.garcia@email.com', '11-9012-3456', '2026-03-23 05:18:07'),
	(10, '34567899', 'Valentina', 'Pérez', 'valentina.perez@email.com', '11-0123-4567', '2026-03-23 05:18:07');
...
-- Volcando datos para la tabla byv_turnos.profesionales: ~5 rows (aproximadamente)
INSERT INTO `profesionales` (`id`, `nombre`, `consultorio_default_id`, `duracion_default`) VALUES
	(1, 'Dr. Juan Pérez', 1, 30),
	(2, 'Dra. Ana Martínez', 2, 30),
	(3, 'Dr. Carlos Gómez', NULL, 30),
	(4, 'Dra. Laura Fernández', 3, 30),
	(5, 'Dra. María Rodríguez', 5, 30);
...
-- Volcando datos para la tabla byv_turnos.profesional_especialidad: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla byv_turnos.turnos: ~7 rows (aproximadamente)
INSERT INTO `turnos` (`id`, `paciente_id`, `profesional_id`, `consultorio_id`, `fecha_hora`, `estado_id`, `fecha_creacion`, `observaciones`, `duracion_minutos`) VALUES
	(1, 1, 1, 1, '2026-03-24 02:01:27', 1, '2026-03-23 05:18:07', 'Primera consulta', 30),
	(2, 2, 2, 2, '2026-03-24 03:01:28', 1, '2026-03-23 05:18:07', 'Control', 30),
	(3, 3, 1, 1, '2026-03-24 04:01:28', 1, '2026-03-23 05:18:07', '', 30),
	(4, 4, 3, 1, '2026-03-25 01:01:28', 1, '2026-03-23 05:18:07', 'Segunda consulta', 30),
	(5, 5, 4, 3, '2026-03-26 01:01:28', 1, '2026-03-23 05:18:07', '', 30),
	(6, 1, 3, 1, '2026-03-25 05:01:28', 1, '2026-03-24 02:10:24', '', 30),
	(7, 1, 1, 1, '2026-03-30 09:00:00', 1, '2026-03-25 01:26:41', '', 30);

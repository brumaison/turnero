...
-- Volcando datos para la tabla byv_turnos.agendas: ~7 rows (aproximadamente)
INSERT INTO `agendas` (`id`, `profesional_id`, `dia_semana`, `hora_inicio`, `hora_fin`, `duracion_minutos`, `activo`, `created_at`) VALUES
	...
	(13, 5, 1, '09:00:00', '12:00:00', 30, 1, '2026-03-29 20:21:42');
...
-- Volcando datos para la tabla byv_turnos.turnos: ~10 rows (aproximadamente)
INSERT INTO `turnos` (`id`, `paciente_id`, `profesional_id`, `consultorio_id`, `fecha_hora`, `estado_id`, `fecha_creacion`, `observaciones`, `duracion_minutos`) VALUES
	...
	(8, 6, 3, 4, '2026-04-04 10:00:00', 1, '2026-03-26 03:32:29', '', 30),
	(9, 1, 2, 2, '2026-03-30 17:10:00', 1, '2026-03-29 20:10:43', '', 30),
	(10, 10, 2, 3, '2026-03-30 18:23:00', 1, '2026-03-29 20:23:29', '', 30);
